...
def test_chinese_graph_visualization():
    ...
    # 直接使用原始函数而非工具
    from multi_agent_system.tools.graph_analysis_tools import _create_entity_graph, _visualize_graph
    
    # 创建知识图谱
    graph_file = _create_entity_graph(entities, relationships, "AI技术知识图谱")
    ...
    for layout in layouts:
        for theme in themes:
            output_file = _visualize_graph(graph_file, layout=layout, color_theme=theme)

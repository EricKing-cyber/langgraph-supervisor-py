...
app.add_node("math_team", math_team)
app.add_node("weather_team", weather_team)
app.add_node("task_router", route_task)

# 设置边
app.add_edge("__start__", "task_router")
app.add_edge("task_router", "math_team")
app.add_edge("task_router", "weather_team")
app.add_edge("task_router", "supervisor")
app.add_edge("math_team", "__end__")
app.add_edge("weather_team", "__end__")

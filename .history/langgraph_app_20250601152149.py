...
math_team = build_supervisor_workflow([math_agent], model).compile(name="math_team")
weather_team = build_supervisor_workflow([weather_agent], model).compile(name="weather_team")

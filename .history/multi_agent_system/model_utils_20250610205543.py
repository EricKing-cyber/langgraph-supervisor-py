...
def create_model(model_name="default_model"):
    """创建语言模型"""
    if model_name.startswith("cogito:"):
    ...
    elif model_name.startswith("qwen3:") or model_name.startswith("qwen:"):
        api_key = os.environ.get('QWEN_API_KEY', 'your_api_key')
        model = ChatAnthropic(
            temperature=0,
        ...
        return model
    elif model_name.startswith("claude-3") or model_name.startswith("claude:"):

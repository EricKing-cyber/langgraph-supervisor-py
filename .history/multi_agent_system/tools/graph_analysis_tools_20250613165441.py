...
def _visualize_graph(graph_file: str, layout: str = "spring", output_format: str = "png") -> str:
    """
    可视化图结构并保存为图片
...
# 使用包装器包装函数，并确保工具名称与提示词中描述的一致
create_knowledge_graph = tool(name="create_knowledge_graph")(_create_entity_graph)
add_entities_to_graph_tool = tool(name="add_entities_to_graph")(_create_entity_graph)
add_relationships_to_graph_tool = tool(name="add_relationships_to_graph")(_create_entity_graph)
analyze_graph_centrality = tool(name="analyze_graph_centrality")(_analyze_graph_centrality)
find_path_between_entities = tool(name="find_path_between_entities")(_find_shortest_path)
detect_communities = tool(name="detect_communities")(_detect_communities)
visualize_graph = tool(name="visualize_graph")(_visualize_graph)
graph_similarity_analysis = tool(name="graph_similarity_analysis")(_graph_similarity_analysis)
extract_subgraph = tool(name="extract_subgraph")(_extract_subgraph)
list_knowledge_graphs_tool = tool(name="list_knowledge_graphs")(list_knowledge_graphs)
...
def get_graph_analysis_tools() -> List[BaseTool]:
    ...
    return [
        ...
        add_entities_to_graph_tool,
        add_relationships_to_graph_tool,
